  ...
  return (
    <button
      ...
      style={{
        ...
        boxShadow: selected
          ? "0 4px 14px rgba(216,67,42,0.22)"
    ...
    >
      {/* poster preview */}
      <div
        className="relative w-full flex flex-col justify-between p-2"
        style={{
          height: "92px",
          background: style.bg,
      ...
      >
        <div className="flex items-center justify-between">
          ...
          <Icon size={12} style={{ color: style.fg, opacity: 0.85 }} />
        </div>
        <div
          className="font-bold"
          style={{
            ...
            fontSize: style.id === "minimal" ? "12px" : "13px",
            lineHeight: 1.25,
          }}
        >
          {style.caption}
      ...
      >
        ...
        <div className="mt-0.5" style={{ color: TEXT_MUTED, fontSize: "10px" }}>
          {style.desc}
        </div>
      </div>
      ...
      {selected && (
        ...
        >
          <Check size={11} color="#FFF6F0" strokeWidth={3} />
        </div>
      )}
    </button>
  );
...
export default function ClipInOne() {
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      if (prompt.trim()) formData.append("customPrompt", prompt.trim());
            ...
            <div className="space-y-3">
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="例：热气缓慢升腾，暖光轻轻晃动，镜头缓慢推进"
                  className="w-full rounded-md px-3 py-2 text-sm focus:outline-none"
                  style={{
                    background: "#fff",
                    border: "1px solid #F3D5C9",
